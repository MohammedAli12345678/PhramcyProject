...
namespace PharmacySystem.view
{
    public partial class Login_view : Form
    {
        ...
        private void BtnLogin_Click(object sender, EventArgs e)
        {
            ...
            {
                var employee = db.employees.FirstOrDefault(s => s.email == emailtb.Text);
                ...
                if (employee != null)
                {
                    ...
                    salesViewItem0.Click += (a,b) => {
                        if(!MinuStripMain.history.Any(h => h.Equals(salesViewItem0.Text)))
                        {
                           ...
                           var f =  new Profile();
                           f.Disposed += (j, d) => { MinuStripMain.history.Remove(salesViewItem0.Text); };
                           f.Show();
                        }
                        else
                        {
                    ...
                    salesViewItem.Click += (a,b) => {
                        if(!MinuStripMain.history.Any(h => h.Equals(salesViewItem.Text)))
                        {
                           ...
                           var f =  new Sales();
                           f.Disposed += (j, d) => { MinuStripMain.history.Remove(salesViewItem.Text); };
                           f.Show();
                        }
                        else
                        {
                    ...
                    salesViewItem1.Click += (a,b) => {
                        if (!MinuStripMain.history.Any(h => h.Equals(salesViewItem1.Text)))
                        {
                            ...
                            var f = new Buys();
                            f.Disposed += (j, d) => { MinuStripMain.history.Remove(salesViewItem1.Text); };
                            f.Show();
                    ...
                    salesViewItem2.Click += (a, b) => {
                        if (!MinuStripMain.history.Any(h => h.Equals(salesViewItem2.Text)))
                        {
                            ...
                            f.Disposed += (j, d) => { MinuStripMain.history.Remove(salesViewItem2.Text); };
                            f.Show();
                    ...
                    salesViewItem3.Click += (a,b) =>{
                        if (!MinuStripMain.history.Any(h => h.Equals(salesViewItem3.Text)))
                        {
                            ...
                            f.Disposed += (j, d) => { MinuStripMain.history.Remove(salesViewItem3.Text); };
                            f.Show();
                    ...
                    if (employee.type.Equals("مدير"))
                    {
                        ...
                        salesViewItem6.Click += (a,b) => {
                            ...
                            f.Disposed += (j, d) => { MinuStripMain.history.Remove(salesViewItem6.Text); };
                            f.Show();
                        };
